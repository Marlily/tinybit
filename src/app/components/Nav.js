    ...
    return (
        ...
        <nav className="w-full flex justify-between px-9 py-8 z-50 flex-wrap">
            ...
            <ul className="flex flex-wrap justify-between items-center mx-auto lg:ml-auto lg:mr-0">
                ...
                <li className="lg:pl-[37px] text-sm cursor-pointer" onClick={() => props.fullpageApi.moveTo(4)}>Realizacje</li>
                <li className="lg:pl-[37px] text-sm cursor-pointer" onClick={() => props.fullpageApi.moveTo(5)}>Kontakt</li>
