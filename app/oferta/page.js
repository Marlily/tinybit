  ...
  return (
     <>
         ...
         <section id="offer" className='pt-20 lg:pt-36 pb-16 lg:pb-28 relative'>
            <div className="container">
               <div className="xl:w-5/6 flex flex-wrap mx-auto">
                  <div className="w-full lg:w-1/2 text-center lg:px-10">
                  ...
                  <div className="w-full lg:w-1/2 text-center lg:px-10 mt-20 lg:mt-0">
         ...
         <section className='relative py-10'>
            ...
            <div className="container">
               <h2 className="uppercase text-4xl lg:text-5xl font-second font-semibold w-full text-center mb-6 lg:mb-12 uppercase">STRONA INTERNETOWA<br/>DOPASOWANA DO TWOJEJ FIRMY</h2>

               <div className="bg-white shadow-xl py-8 px-8 lg:px-24 mb-10 lg:mb-32">
         ...
         <section className='pb-20 lg:pb-32 relative overflow-hidden'>
            ...
            <div className="container">
               ...
               <h2 className="uppercase text-4xl lg:text-5xl font-second font-semibold w-full text-center mb-12 lg:mb-24 uppercase">Jak przebiega współpraca?</h2>
               <ul className="list-none p-0 m-0">
