        ...
        <nav className="py-10 bg-light-gray z-50 relative">
            <div className="container flex flex-wrap lg:flex-nowrap items-center ">
                ...
                <ul className={`ml-auto flex flex-col lg:justify-end lg:mr-12 lg:flex-row gap-x-7 w-full text-right pt-5 lg:pt-0 z-40 bg-light-gray order-1 lg:order-none transition-[margin] ${menu ? 'mt-0' : 'mt-[-27rem] lg:mt-0'}`}>
                    <Link href="/" className="font-second uppercase font-medium text-dark text-base relative after:content-[''] after:absolute after:block after:transition-[width] after:w-0 after:bg-dark after:h-px hover:after:w-full after:opacity-0 lg:after:opacity-100">Strona główna</Link>
                    <Link href="/oferta" className="font-second uppercase font-medium text-dark text-base relative after:content-[''] after:absolute after:block after:transition-[width] after:w-0 after:bg-dark after:h-px hover:after:w-full after:opacity-0 lg:after:opacity-100">Oferta</Link>
                </ul> 
